    ...
    if (errorType) {
      switch (errorType) {
        case 'OAuthAccountNotLinked':
          setError('This email account is already registered with a different provider. Please use the same login method you originally used.')
          setShowError(true)
          break
        case 'OAuthCallback':
          setError('Authentication process error. Please try again.')
          setShowError(true)
          break
        case 'OAuthCreateAccount':
          setError('Could not create account. Please try another method.')
          setShowError(true)
          break
    ...
    try {
      ...
      if (result?.error) {
        ...
        if (result.error.includes('CredentialsSignin')) {
          ...
          errorMessage = 'This email account is already registered with a different provider.'
        }
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 relative">
                    ...
                    {error.includes('different provider') && (
                      <div className="mt-2">
                        <p className="text-red-300 text-xs mb-2">
                          Don&apos;t remember which method you used?
                        </p>
                        <button
                          onClick={clearError}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-700/50 border border-slate-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-slate-700/50 border border-slate-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200"
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={loading}
                className="flex items-center justify-center px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-xl text-gray-300 hover:bg-slate-700/70 hover:border-yellow-500/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group"
              >
            ...
            {/* Help Text for OAuth Errors */}
            {errorType === 'OAuthAccountNotLinked' && (
              <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                <p className="text-blue-400 text-xs text-center">
                  💡 <strong>Tip:</strong> If you don&apos;t remember which method you used, try password recovery or contact support.
                </p>
              </div>
            )}
