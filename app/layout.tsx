...
export const metadata: Metadata = {
  ...
  // Icons - Asegúrate de que las rutas sean absolutas
  icons: {
    icon: [
      { url: "/favicon.ico" },
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Favicon links adicionales para asegurar compatibilidad */}
      ...
      {isProduction && (
        <>
          <GoogleTagManager gtmId={process.env.NEXT_PUBLIC_GTM_ID || 'GTM-NRHT8WVS'} />
          <GoogleAnalytics gaId={process.env.NEXT_PUBLIC_GA_ID || 'G-0L0GZHZ3ZW'}/>
        </>
      )}
    </html>
  );
