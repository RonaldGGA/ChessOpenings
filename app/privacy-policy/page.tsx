...
import { FaShieldAlt, FaDatabase, FaUserCheck, FaEnvelope } from 'react-icons/fa';
...
const PrivacyPolicyPage = () => {
  ...
  const dataTypes = [
    ...
    {
      title: "Usage Data",
      items: ["Game history", "Opening preferences", "Practice sessions", "Browser type", "IP address"]
    },
    {
  ...
  const dataUsage = [
    ...
    },
    {
      icon: FaDatabase,
      title: "Improvements",
      description: "To analyze and improve our platform's performance and features"
    },
    {
      icon: FaEnvelope,
      title: "Communication",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              We do not sell your personal data to third parties. We only share data with trusted service providers 
              who assist us in operating our platform, and only to the extent necessary to provide our services.
            </p>
          </section>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 text-center">
            ...
            <p className="text-gray-300 mb-6">
              If you have any questions about our privacy practices or your personal data, we&apos;re here to help.
            </p>
